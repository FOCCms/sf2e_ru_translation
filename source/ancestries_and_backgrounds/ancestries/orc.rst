...
Хотя они уважают физическую мощь :doc:`Горумских </lost_omens/Deity/Core/Gorum>` боевых жрецов и даже друидов, которые принимают облик великих зверей, они считают арканную и оккультную магию сомнительной в лучшем случае и неэтичной в целом.
...
:doc:`/lost_omens/Deity/Core/Gorum`, :doc:`/lost_omens/Deity/Core/Lamashtu` и :doc:`/lost_omens/Deity/Core/Rovagug` наиболее почитаемые в орочьих сообществах, хотя менее жестокие придерживаются поклонения природным божествам, таким как :doc:`/lost_omens/Deity/Core/Gozreh`, или богам, таким как :doc:`/lost_omens/Deity/Core/Sarenrae`, чьи догматы огня, искупления и славы имеют некоторую привлекательность для чувств орков.
...
Вооруженные своей верой в :doc:`/lost_omens/Deity/Core/Sarenrae`, холд "Палящего солнца" посвящен направлению культуры орков на более праведный путь.
...
.. admonition:: Уточнение PFS
	...
	Временные ОЗ применяются как только персонаж успешно совершил спасбросок.
...
**Особенность**: Вы можете использовать это свободное действие даже если у вас есть состояние связанное с состоянием :c_frightened:`напуган`, которое обычно не дает вам использовать свободные действия, как например ":c_fleeing:`бегство` пока :c_frightened:`напуган`" или ":c_paralyzed:`парализован` пока :c_frightened:`напуган`".

.. versionchanged:: /errata-LOAG-2
	В особенностях все свободное действие упоминалось как "реакция".
