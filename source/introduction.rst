...
1. Введение `(Introduction) <https://2e.aonprd.com/Rules.aspx?ID=1>`_
===================================================================================
...
Их можно найти в :ref:`Бестиарии Pathfinder <Creatures--Bestiary>`, который является незаменимой книгой для Мастеров.
...
.. sidebar:: hidden
	...
	Помимо персонажей и монстров, мир Pathfinder сам по себе может быть влияющей силой и частью повествования.
	...
	Ловушки и сокровища также важны во многих историях, как и хитрые чудовища.
...
Когда существо пытается навредить другому, оно совершает :ref:`action--Strike` или использует другое атакующее действие.
...
.. _ch1--Understanding-Actions--Single:
...
Если активность предназначена для выполнения в режиме исследования, то у нее есть признак :t_exploration:`исследование`.
Активность, которая занимает день или больше и которая может быть выполнена только во время отдыха, имеет признак :t_downtime:`отдых`.
...
Еще элементы правил часто обладают связанными с ними признаками (они перечислены в :ref:`Appendix--Traits`).

Заклинания, алхимические и магические предметы используют похожий формат, но их блоки характеристик содержат некоторые уникальные элементы (см. Главу :ref:`ch7--spells`, чтобы почитать больше о заклинаниях, и Главу :ref:`ch11--crafting-and-treasures` для подробностей о алхимических и магических предметах).
...
Резюме по родословным (:ref:`ch1--Creating--Resume--Ancestries`) дают обзор основных вариантов родословной в Pathfinder, и каждая из них полностью описана в Главе :ref:`ch2--ancestries-and-backgrounds`.
...
.. _sidebar--Alternate-Ancestry-Boosts:
.. rst-class:: sidebar-char-ancestry-class

.. sidebar:: hidden

	.. rubric:: Альтернативные повышения характеристик родословных (Alternate Ancestry Boosts)

	Повышения и недостатки характеристик, перечисленные в каждой родословной, представляют собой общие тенденции или помогают игрокам создать персонажей этой родословной, наиболее склонных к жизни искателя приключений.
	Однако родословные не являются монолитными.
	При создании персонажа, у вас всегда есть возможность полностью заменить указанные в родословной повышения и недостатки характеристик и вместо них выбрать два свободных повышения характеристик.

	.. versionadded:: /errata-CR-r4
		Добавлено правило "Альтернативные повышения характеристик родословных (Alternate Ancestry Boosts)".

	.. _sidebar--Voluntary-Flaws:
	.. rubric:: Опционально: Добровольные недостатки (Voluntary Flaws)

	Иногда весело играть персонажем с сильным недостатком, независимо от его родословной.
	Вы можете взять дополнительный недостаток характеристики когда применяете повышения и недостатки своей родословной.
	Это исключительно для ролевого отыгрыша персонажа с сильным недостатком, и если вы планируете это сделать, то должны обсудить это с остальной группой.
	Вы не можете применять более одного недостатка к одной и той же характеристике.

	.. versionchanged:: /errata-CR-r4
		Изменены "Добровольные недостатки (Voluntary Flaws)" - они теперь исключительно для отыгрыша и не дают преимуществ.
...
Если он переносит количество массы, которое превышает 5 + модификатор Силы, то он получает состояние :c_encumbered:`перегружен`.
...
Если персонаж получает увеличение навыка, обратитесь к Главе :ref:`ch4--skills`, когда решаете к какому навыку его применить.
...
Также хорошей идеей является посмотреть доступные заклинания в Главе :ref:`ch7--spells` и найти усиленные версии доступных заклинаний.
