...
.. title:: Списки заклинаний (Spell Lists)
...
:ref:`spell--Needle-Darts` :sup:`У` :sup:`RoE`: Превращает кусочек металла в иглы и выпускает их в противника.

:ref:`spell--Time-Sense` :sup:`DA` (прориц.): Вы прекрасно ощущаете время.

:ref:`spell--Phase-Bolt` :sup:`У` :sup:`DA` (эвок.): Выпускает магический снаряд, который может проходить сквозь щиты и укрытия.

:ref:`spell--Warp-Step` :sup:`DA` (вопл.): Сжимает пространство, позволяя при передвижении пройти большее расстояние.

:ref:`spell--Approximate` :sup:`SoM` (прориц.): Магически подсчитывает примерное количество объектов поблизости.

:ref:`spell--Bullhorn` :sup:`У` :sup:`SoM` (иллюз.): Усиливает ваш голос, чтобы его слышали на большом расстоянии.

:ref:`spell--Gale-Blast` :sup:`У` :sup:`SoM` (эвок.): С помощью воздуха наносит урон и отталкивает находящихся радом существ.

:ref:`spell--Gouging-Claw` :sup:`У` :sup:`SoM` (трансм.): Трансформирует вашу конечность в коготь и атакует им.

:ref:`spell--Infectious-Enthusiasm` :sup:`SoM` (очар.): Подбадривает вас и союзника улучшить по одному броску.

:ref:`spell--Protect-Companion` :sup:`У` :sup:`SoM` (прегр.): Защищает от вреда вашего миньона или эйдолона.

:ref:`spell--Puff-Of-Poison` :sup:`У` :sup:`SoM` (эвок.): Выдыхает токсины, чтобы отравить противника.

:ref:`spell--Scatter-Scree` :sup:`У` :sup:`SoM` (эвок.): Создает камни, чтобы нанести дробящий урон и сделать каменистую сложную местность.

:ref:`spell--Spout` :sup:`У` :sup:`SoM` (эвок.): Бьет существ водным взрывом, который становится больше если сотворять его в водоеме.

:ref:`spell--Invoke-True-Name` :sup:`Р` :sup:`SoM` (очар.): Знание истинного имени существа делает его уязвимее для вашей магии.
...
:ref:`spell--Ignition` :sup:`У`: Воспламеняете существо на расстоянии или вблизи.
...
:ref:`spell--s--Shield` :sup:`У` (прегр.): Щит магической силы блокирует атаки и *магические снаряды*.
...
:ref:`spell--Dehydrate` :sup:`У` :sup:`RoE`: Иссушает существ, нанося им урон и :c_enfeebled:`ослабляя`.

:ref:`spell--Flourishing-Flora` :sup:`У` :sup:`RoE`: Выращивает участок кактусов, цветов, фруктов или корней, чтобы ранить ваших врагов.

:ref:`spell--Wall-of-Shrubs` :sup:`У` :sup:`RoE`: Создаете стену кустарников, дающую укрытие.

:ref:`spell--Kinetic-Ram` :sup:`DA` (эвок.): Использует волны силы для отталкивания противников.

:ref:`spell--Breadcrumbs` :sup:`У` :sup:`SoM` (прегр.): Оставляет след за существом.

:ref:`spell--Draw-Ire` :sup:`У` :sup:`SoM` (очар.): Ментально жалит разум существа, чтобы оно стало менее способным атаковать других существ, помимо вас.

:ref:`spell--Echoing-Weapon` :sup:`У` :sup:`SoM` (эвок.): Ваши атаки накапливаются в оружии, чтобы выпустить звуковой импульс.

:ref:`spell--Gravitational-Pull` :sup:`SoM` (эвок.): Притягивает к вам 1 или более существ с помощью гравитации.

:ref:`spell--Horizon-Thunder-Sphere` :sup:`У` :sup:`SoM` (эвок.): Собирает энергию и метает шаровую молнию.

:ref:`spell--Mud-Pit` :sup:`SoM` (вопл.): Создает грязь для замедления передвижения.

:ref:`spell--Necromancers-Generosity` :sup:`У` :sup:`SoM` (некр.): Исцеляет вашего миньон :t_undead:`нежить` и защищает его от :t_positive:`позитивной` энергии.

:ref:`spell--Nudge-The-Odds` :sup:`Н, У` :sup:`SoM` (прориц.): Жульничает в азартных играх.

:ref:`spell--Pocket-Library` :sup:`У` :sup:`SoM` (прориц.): Достает книги из карманной библиотеки.

:ref:`spell--Quick-Sort` :sup:`У` :sup:`SoM` (трансм.): Автоматически сортирует множество объектов.

:ref:`spell--Restyle` :sup:`SoM` (трансм.): Навсегда изменяет стиль одежды.

:ref:`spell--Schadenfreude` :sup:`SoM` (очар.): Реагируете на свой критический провал, чтобы отвлечь противников ликованием.

:ref:`spell--Seashell-Of-Stolen-Sound` :sup:`SoM` (прориц.): Копирует звук в магическую морскую ракушку.

:ref:`spell--Synchronize` :sup:`У` :sup:`SoM` (прориц.): Размещает на ваших целях сигилы, которые вспыхивают в заданное время.

:ref:`spell--Thicket-Of-Knives` :sup:`SoM` (иллюз.): Иллюзорные копии вашего оружия улучшают возможность финтовать.
...
:ref:`spell--p--Pummeling-Rubble` :sup:`У` :sup:`APG` (эвок.): Запускает конус камней, чтобы нанести урон существам.
...
:ref:`spell--Thunderstrike` :sup:`У` :sup:`PC`: Призывает грохочущий удар молнии.

:ref:`spell--s--Shocking-Grasp` :sup:`У` (эвок.): Ударяет существо током.

:ref:`spell--s--Sleep` :sup:`У` (очар.): Заставляет заснуть существ в небольшой области.
...
:ref:`spell--Clad-in-Metal` :sup:`У` :sup:`RoE`: Покрывает предмет металлом на ваш выбор.

:ref:`spell--Loose-Times-Arrow` :sup:`DA` (трансм.): С помощью времени усиливает передвижение группы существ.

:ref:`spell--Empty-Pack` :sup:`У` :sup:`DA` (иллюз.): Делает объекты внутри контейнера невидимыми.

:ref:`spell--Ash-Cloud` :sup:`У` :sup:`SoM` (вопл.): Призывает облако горячего пепла и дыма.

:ref:`spell--Befitting-Attire` :sup:`У` :sup:`SoM` (иллюз.): Маскирует одежду, чтобы она подходила для события.

:ref:`spell--Elemental-Zone` :sup:`У` :sup:`SoM` (эвок.): Делает одну стихию в зоне более вредящей.

:ref:`spell--Extract-Poison` :sup:`SoM` (прегр.): Вытягивает яд из объекта и делает вашу следующую атаку отравленной.

:ref:`spell--Flame-Wisp` :sup:`У` :sup:`SoM` (эвок.): Огоньки пламени наносят урон тем, кого вы бьете и если сотворяете огненные заклинания, то появляются новые.

:ref:`spell--Ignite-Fireworks` :sup:`У` :sup:`SoM` (эвок.): Метает взрывающийся фейерверк.

:ref:`spell--Instant-Armor` :sup:`SoM` (вопл.): Заготавливает в межпространственном кармане доспех на чрезвычайный случай.

:ref:`spell--Lucky-Number` :sup:`SoM` (прориц.): Подготавливает сопряженность, чтобы перебросить определенный, случайно выбираемый результат d20.

:ref:`spell--Magnetic-Attraction` :sup:`SoM` (эвок.): Тянет предметы магнетизмом, даже разоружая металлическое оружие.

:ref:`spell--Magnetic-Repulsion` :sup:`У` :sup:`SoM` (прегр.): Отталкивает металл, защищая от металлического оружия и врагов в доспехах.

:ref:`spell--Persistent-Servant` :sup:`SoM` (вопл.): Призывает долговременного незримого слугу для одной задачи.

:ref:`spell--Phantom-Crowd` :sup:`У` :sup:`SoM` (иллюз.): Создает иллюзорную толпу, которая громко соглашается с вами.

:ref:`spell--Scorching-Ray` :sup:`У` :sup:`SoM` (эвок.): Выпускает в разных врагов от 1 до 3 лучей тепла и пламени.

:ref:`spell--Summoners-Precaution` :sup:`SoM` (некр.): Готовит сопряженность, чтобы избежать потери сознания вместе с эйдолоном.

:ref:`spell--Summoners-Visage` :sup:`У` :sup:`SoM` (трансм.): Визуально меняет вашего эйдолона, чтобы он выглядел в точности как вы.

:ref:`spell--Timely-Tutor` :sup:`SoM` (прориц.): Подключает вашего эйдолона или фамильяра к Акашийской Хронике, чтобы кратковременно дать вам их знания.

:ref:`spell--Umbral-Extraction` :sup:`SoM` (иллюз.): Пытается украсть слот заклинания.

:ref:`spell--Warriors-Regret` :sup:`У` :sup:`SoM` (очар.): Когда противник вредит другим, его разум переполняют сожаления.
...
:ref:`spell--r--Resist-Energy` :sup:`У` (прегр.): Защищает существо от одного типа энергетического урона.
...
:ref:`spell--Sand-Form` :sup:`У` :sup:`RoE`: Превращает тело и снаряжение существа в песок.

:ref:`spell--Temporal-Twin` :sup:`Н` :sup:`DA` (вопл.): Призывает версию союзника из прошлой линии времени, для повторения простых действий.

:ref:`spell--Time-Pocket` :sup:`DA` (трансм.): Посылает объект вперед во времени, чтобы он прибыл позднее.

:ref:`spell--Bracing-Tendrils` :sup:`DA` (эвок.): Завитки из силы предотвращают нежелательное передвижение.

:ref:`spell--Rally-Point` :sup:`Н, У` :sup:`DA` (вопл.): Обозначает точку в которую можете телепортироваться силой мысли.

:ref:`spell--Sea-of-Thought` :sup:`У` :sup:`DA` (вопл.): Жидкие мысли формируют медленно двигающуюся трясину.

:ref:`spell--Blazing-Dive` :sup:`У` :sup:`SoM` (эвок.): Взлетаете вверх, а потом пикируете со взрывом перегретого воздуха.

:ref:`spell--Bottomless-Stomach` :sup:`У` :sup:`SoM` (вопл.): Хранит вещи в животе существа.

:ref:`spell--Days-Weight` :sup:`У` :sup:`SoM` (трансм.): Использует временную магию, чтобы утомить существо.

:ref:`spell--Distracting-Chatter` :sup:`У` :sup:`SoM` (иллюз.): Отвлекает существо :t_auditory:`слуховой` иллюзией.

:ref:`spell--Elemental-Absorption` :sup:`У` :sup:`SoM` (прегр.): Сопротивляется эффектам стихий и потом высвобождает эту энергию в противника.

:ref:`spell--Elemental-Annihilation-Wave` :sup:`У` :sup:`SoM` (эвок.): Черпает стихийную энергию, чтобы испустить конус жгущего разрушения.

:ref:`spell--Impending-Doom` :sup:`У` :sup:`SoM` (прориц.): Показывает противнику его возможную кончину и вызывает беспокойство.

:ref:`spell--Magnetic-Acceleration` :sup:`У` :sup:`SoM` (эвок.): Магнетически запускает предмет, чтобы атаковать врага.

:ref:`spell--Mind-of-Menace` :sup:`SoM` (очар.): Устанавливает сопряженность, чтобы покарать врага за ментальный эффект и защитить вас от него.

:ref:`spell--Oneiric-Mire` :sup:`SoM` (иллюз.): Создает иллюзорный зыбучий песок, заставляющий думать существ, что они застряли.

:ref:`spell--Ooze-Form` :sup:`У` :sup:`SoM` (трансм.): Превращает в боевую форму слизи.

:ref:`spell--Organsight` :sup:`У` :sup:`SoM` (прориц.): Видите органы противника, и используете эти знания для нанесения точного урона.

:ref:`spell--Phantom-Prison` :sup:`У` :sup:`SoM` (иллюз.): Запираете существо в иллюзорных стенах, пока оно не перестанет верить в них.

:ref:`spell--Roaring-Applause` :sup:`У` :sup:`SoM` (очар.): Заставляет цель подбадривать вас и аплодировать.

:ref:`spell--Rouse-Skeletons` :sup:`У` :sup:`SoM` (некр.): Поднимает отряд скелетов, чтобы царапать врагов.

:ref:`spell--Shadow-Projectile` :sup:`У` :sup:`SoM` (иллюз.): Реагируете когда союзник совершает дистанционную атаку, чтобы создать ее теневой дубликат, отвлекая противника и нанося урон.

:ref:`spell--Shift-Blame` :sup:`SoM` (очар.): Обманывает кого-то, заставив думать, что в вашей атаке или промахе виноват кто-то другой.

:ref:`spell--Time-Jump` :sup:`SoM` (трансм.): Совершаете скачок вперед во времени, стремительно двигаясь.

:ref:`spell--Wall-Of-Water` :sup:`SoM` (вопл.): Создает стену воды, заставляя врагов плыть через нее.

:ref:`spell--Warding-Aggression` :sup:`SoM` (прегр.): :ref:`Ударяете (Strike) <action--Strike>` врага, чтобы улучшить против него свою защиту и расширить заклинание дальнейшими атаками.

:ref:`spell--Web-Of-Eyes` :sup:`SoM` (прориц.): Помещает на существ датчики :t_scrying:`видения`, позволяющие им делиться своим зрением с другими.
...
:ref:`spell--g--Gravity-Well` :sup:`У` :sup:`LOGM` :sup:`SoM` (эвок.): Создаете сферу измененной гравитации, которая притягивает все в свой центр.
...
:ref:`spell--Rust-Cloud` :sup:`У` :sup:`RoE`: Создает облако песчинок ржавчины, которые наносят существам порезы и ржавеют металл.

:ref:`spell--Morass-of-Ages` :sup:`DA` (трансм.): Темпоральные вихри делают каждый шаг похожим на вечность.

:ref:`spell--Soft-Landing` :sup:`DA` (прегр.): Создает магическое поле, подхватывающее падающих существ и объекты.

:ref:`spell--f--False-Nature` :sup:`Н` :sup:`DA` (иллюз.): Создает иллюзию, заставляя объект казаться чем-то совершенно другим.

:ref:`spell--Chromatic-Armor` :sup:`У` :sup:`SoM` (прегр.): Светящийся доспех излучает свет, ослепляя врагов и давая случайные сопротивления.

:ref:`spell--Chromatic-Ray` :sup:`У` :sup:`SoM` (эвок.): Луч света вызывает эффекты в зависимости от своего цвета.

:ref:`spell--Coral-Eruption` :sup:`У` :sup:`SoM` (вопл.): Создает область острых как бритва ранящих кораллов.

:ref:`spell--Draw-The-Lightning` :sup:`У` :sup:`SoM` (эвок.): Призывает молнию в вас или ваше оружие.

:ref:`spell--Invisibility-Curtain` :sup:`У` :sup:`SoM` (иллюз.): Стена делает существ с одной стороны невидимыми по другую сторону.

:ref:`spell--Magic-Mailbox` :sup:`Н` :sup:`SoM` (вопл.): Межпространственно связывает 2 контейнера.

:ref:`spell--Mirrors-Misfortune` :sup:`SoM` (иллюз.): Разделяетесь на 2 копии. Уничтожение подделки проклинает атакующего.

:ref:`spell--Ocular-Overload` :sup:`SoM` (иллюз.): Устанавливает сопряженность, чтобы вмешаться в зрение атакующего вас существа.

:ref:`spell--Ravenous-Portal` :sup:`SoM` (прегр.): Дверь превращается в мимика, когда другие пытаются открыть ее.

:ref:`spell--Replicate` :sup:`У` :sup:`SoM` (иллюз.): Создает иллюзию дублирующую существо.

:ref:`spell--Sanguine-Mist` :sup:`У` :sup:`SoM` (некр.): Создает облако тумана осушающего жизнь, который перекачивает жизненную силу в вас.

:ref:`spell--Umbral-Graft` :sup:`SoM` (иллюз.): Пытается украсть активное заклинание.

:ref:`spell--Variable-Gravity` :sup:`У` :sup:`SoM` (трансм.): Меняет силу гравитации вокруг вас между высокой, низкой и нормальной.

:ref:`spell--Winning-Streak` :sup:`SoM` (прориц.): Ускоряет цель, а ее критические попадания распространяют это ускорение.

:ref:`spell--Compel-True-Name` :sup:`Р` :sup:`SoM` (очар.): Заставляет существо выполнить действия, когда вы называете его по истинному имени.
...
:ref:`spell--Entwined-Roots` :sup:`У` :sup:`RoE`: Защищает существ прочными корнями, способными ловить снаряды.

:ref:`spell--Flames-of-Ego` :sup:`RoE`: Освещает существо и :c_fascinated:`завораживает` его самим собой.

:ref:`spell--Freezing-Rain` :sup:`У` :sup:`RoE`: Охлаждает и замедляет существ холодным дождем.

:ref:`spell--Pressure-Zone` :sup:`RoE`: Снижает давление воздуха, чтобы лишить слуха и ослабить.

:ref:`spell--Quicken-Time` :sup:`DA` (трансм.): Ускоряет время поблизости.

:ref:`spell--Stagnate-Time` :sup:`DA` (трансм.): Замедляет время поблизости.

:ref:`spell--Etheric-Shards` :sup:`У` :sup:`DA` (эвок.): Заполняет область сверкающими клинками из силы.

:ref:`spell--Bandits-Doom` :sup:`У` :sup:`SoM` (прегр.): Устанавливает оберег для защиты предмета.

:ref:`spell--Blazing-Fissure` :sup:`У` :sup:`SoM` (эвок.): Разрывает землю магматическими трещинами.

:ref:`spell--Blink-Charge` :sup:`У` :sup:`SoM` (вопл.): Телепортируетесь и атакуете магической силой.

:ref:`spell--Flammable-Fumes` :sup:`У` :sup:`SoM` (вопл.): Вызывает ядовитые испарения, которые могут взрываться в пламени.

:ref:`spell--Flowing-Strike` :sup:`SoM` (эвок.): Плывете по волне и по пути атакуете.

:ref:`spell--Forceful-Hand` :sup:`У` :sup:`SoM` (эвок.): Создает руку из силы, которая может вмешиваться, чтобы защищать вас или, если усилена, то и атаковать.

:ref:`spell--Geyser` :sup:`У` :sup:`SoM` (эвок.): Подкидывает противников вверх перегретой водой, заставляя их падать и оставляя скрывающий туман.

:ref:`spell--Glimmer-Of-Charm` :sup:`SoM` (очар.): Ненадолго улучшает отношение ближайших существ с помощью ауры шарма.

:ref:`spell--Invoke-Spirits` :sup:`У` :sup:`SoM` (некр.): Призывает группу призрачных явлений, чтобы атаковать ваших врагов.

:ref:`spell--Mantle-Of-The-Frozen-Heart` :sup:`SoM` (трансм.): Превращает ваше тело в лед, которое вы можете изменять во время действия заклинания.

:ref:`spell--Mantle-Of-The-Magma-Heart` :sup:`SoM` (трансм.): Превращает ваше тело в огонь, которое вы можете изменять во время действия заклинания.

:ref:`spell--Mirror-Malefactors` :sup:`У` :sup:`SoM` (иллюз.): Зеркала окружают цель, а отражения постоянно атакуют ее.

:ref:`spell--Rewinding-Step` :sup:`У` :sup:`SoM` (трансм.): Привязывает ваше местоположение во времени, чтобы вы могли быстро вернуться.

:ref:`spell--Temporary-Glyph` :sup:`SoM` (прегр.): Быстро начертает недолговечный глиф, чтобы взорвать противников.

:ref:`spell--b--Blister` :sup:`У` :sup:`APG` (некр.): Отращивает на существе большие волдыри и лопает их, чтобы разбрызгать кислоту.
...
:ref:`spell--Awaken-Entropy` :sup:`У` :sup:`DA` (некр.): Состаривает существ и объекты в пыль.

:ref:`spell--Poltergeists-Fury` :sup:`У` :sup:`DA` (эвок.): Становитесь центром яростного телекинетического шторма.

:ref:`spell--Cast-Into-Time` :sup:`У` :sup:`SoM` (прориц.): Заставляет существо провалиться сквозь время, нанося ему урон и вызывая :c_sickened:`тошноту`.

:ref:`spell--Chromatic-Image` :sup:`SoM` (иллюз.): Цветные зеркальные образы ранят врагов которые их уничтожают.

:ref:`spell--Daemon-Form` :sup:`SoM` (трансм.): Превращает в боевую форму :t_daemon:`дэймона`.

:ref:`spell--Demon-Form` :sup:`SoM` (трансм.): Превращает в боевую форму :t_daemon:`демона`.

:ref:`spell--Devil-Form` :sup:`SoM` (трансм.): Превращает в боевую форму :t_devil:`дьявола`.

:ref:`spell--Elemental-Confluence` :sup:`SoM` (вопл.): Призывает слияние элементалей всех четырех стихий.

:ref:`spell--Flame-Vortex` :sup:`У` :sup:`SoM` (эвок.): Вызывает двигающееся торнадо из огня и ветра.

:ref:`spell--Necrotize` :sup:`У` :sup:`SoM` (некр.): Омертвляет тело противника, раня его и случайным образом ослабляя.

:ref:`spell--Unexpected-Transposition` :sup:`SoM` (вопл.): Реагируете, чтобы поменяться местами с существом.

:ref:`spell--Zero-Gravity` :sup:`Н` :sup:`SoM` (эвок.): Убирает в области гравитацию.

:ref:`spell--Catch-Your-Name` :sup:`Р` :sup:`SoM` (прориц.): Узнаете истинное имя того, кто назвал вас по имени.
...
:ref:`spell--Pollen-Pods` :sup:`У` :sup:`RoE`: Выращивает взрывающиеся, наполненные пыльцой луковицы, похожие на ловушки.

:ref:`spell--Momentary-Recovery` :sup:`DA` (вопл.): Делаете несколько простых действий одновременно с телепортацией.

:ref:`spell--Telekinetic-Bombardment` :sup:`У` :sup:`DA` (эвок.): Метаете большие объекты своим разумом.

:ref:`spell--Corrosive-Body` :sup:`У` :sup:`SoM` (трансм.): Превращает ваше тело в живую кислоту.

:ref:`spell--Frigid-Flurry` :sup:`У` :sup:`SoM` (эвок.): Превращает влагу из воздуха в режущие снежинки и вы летите по прямой линии.

:ref:`spell--Inexhaustible-Cynicism` :sup:`SoM` (очар.): Делает существ параноидальными и циничными.

:ref:`spell--Prismatic-Armor` :sup:`У` :sup:`SoM` (прегр.): Многоцветный доспех ослепляет врагов и защищает от многих типов урона.

:ref:`spell--Shadow-Raid` :sup:`У` :sup:`SoM` (иллюз.): Рой иллюзорных теней наносит урон врагам в области и дает :c_concealed:`сокрытие`.

:ref:`spell--Tempest-Of-Shades` :sup:`SoM` (некр.): Призывает инкарнацию торнадо из теней-нежити, чтобы истощить и напугать противников.
...
:ref:`spell--Ferrous-Form` :sup:`У` :sup:`RoE`: Превращает ваше тело в железо.

:ref:`spell--Whirlpool` :sup:`У` :sup:`RoE`: Создает водяной водоворот.

:ref:`spell--Summon-Irii` :sup:`Р` :sup:`DA` (вопл.): Призывает стража из Измерения Времени, чтобы привнести неизменяемость или вероятность.

:ref:`spell--Falling-Sky` :sup:`DA` (эвок.): Телекинетически бьет летающих существ о землю.

:ref:`spell--Boil-Blood` :sup:`У` :sup:`SoM` (эвок.): Кипятит кровь противника.

:ref:`spell--Burning-Blossoms` :sup:`У` :sup:`SoM` (очар.): Дерево завораживает врагов и жжет стоящих под ним существ.

:ref:`spell--Summon-Archmage` :sup:`SoM` (вопл.): Призывает инкарнацию архимага, чтобы выпустить магические снаряды, одурманить врагов и разорвать их заклинания.
...
:ref:`spell--m--Maze` (вопл.): Ловит существо в межпространственный лабиринт.
...
:ref:`spell--Bilocation` :sup:`DA` (вопл.): Существуете одновременно в двух местах.

:ref:`spell--Proliferating-Eyes` :sup:`SoM` (прориц.): Вживляет заразный, видящий глаз, который распространяется на других через касание.

:ref:`spell--Summon-Draconic-Legion` :sup:`SoM` (вопл.): Призывает инкарнацию легиона драконов, чтобы уничтожить ваших врагов.

:ref:`spell--Unspeakable-Shadow` :sup:`SoM` (иллюз.): Превращает тень существа в пугающего монстра и заставляя бежать или сражаться.
...
:ref:`spell--m--Meteor-Swarm` :sup:`У` (эвок.): Вызывает 4 взрывающихся метеора.
...
:ref:`spell--Summon-Ancient-Fleshforged` :sup:`Р` :sup:`LOIL` (вопл.): Призывает одно из древних личных живых орудий самого Некса.
...
:ref:`spell--Fated-Confrontation` :sup:`SoM` (прориц.): Изолирует двух предопределенных противников и дает им искажать судьбы друг друга.

:ref:`spell--Nullify` :sup:`SoM` (прегр.): Реагируете, чтобы автоматически противодействовать заклинанию и получить урон от отдачи.

:ref:`spell--Shadow-Army` :sup:`SoM` (иллюз.): Дублируете себя, чтобы ваши тени сражались с врагами, пока вы прячетесь среди них.
...
Сакральные заклинания (Divine Spell List)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. _spells-list--Divine--Cantrips:
...
:ref:`spell--Haunting-Hymn` :sup:`У` :sup:`SoM` (эвок.): Мощный гимн вредит и оглушает.

:ref:`spell--Protect-Companion` :sup:`У` :sup:`SoM` (прегр.): Защищает от вреда вашего миньона или эйдолона.

:ref:`spell--Read-The-Air` :sup:`SoM` (прориц.): Улавливает социальные сигналы.

:ref:`spell--Wash-Your-Luck` :sup:`SoM` (прегр.): Игнорирует одну :t_misfortune:`неудачу`.
...
:ref:`spell--Concordant-Choir` :sup:`У` :sup:`SoM` (эвок.): Ранит противников музыкой.
...
:ref:`spell--Summon-Lesser-Servitor` :sup:`У` :sup:`SoM` (вопл.): Призывает малозначимого :t_celestial:`небожителя`, :t_monitor:`наблюдателя` или :t_fiend:`беса`.
...
:ref:`spell--Guiding-Star` :sup:`SoM` (прориц.): Созвездия подталкивают цель отправиться в выбранное вами место.

:ref:`spell--Inner-Radiance-Torrent` :sup:`У` :sup:`SoM` (некр.): Собирает духовную энергию, чтобы выпустить бурю силовых снарядов и лучей.

:ref:`spell--Instant-Armor` :sup:`SoM` (вопл.): Заготавливает в межпространственном кармане доспех на чрезвычайный случай.

:ref:`spell--Lucky-Number` :sup:`SoM` (прориц.): Подготавливает сопряженность, чтобы перебросить определенный, случайно выбираемый результат d20.

:ref:`spell--Mimic-Undead` :sup:`SoM` (некр.): Притворяетесь :t_undead:`нежитью`.
...
:ref:`spell--f--Faerie-Fire` (эвок.): Цветное свечение мешает существам стать :c_concealed:`скрытыми` или :c_invisible:`невидимыми`.

:ref:`spell--g--Gentle-Repose` :sup:`У` (некр.): Тело не разлагается и не может стать нежитью.

:ref:`spell--g--Ghoulish-Cravings` (некр.): Заражает существо лихорадкой гуля.
...
:ref:`spell--Clawsong` :sup:`Н, У` :sup:`AP171` (трансм.): Усиливает атаки когтей готового существа.
...
:ref:`spell--Behold-the-Weave` :sup:`У` :sup:`DA` (прориц.): Просматривает линии времени, чтобы что-то произошло с большей вероятностью.

:ref:`spell--Focusing-Hum` :sup:`DA` (прориц.): Приятный гул помогает сопротивляться отвлекающим факторам.

:ref:`spell--Claim-Curse` :sup:`SoM` (некр.): Временно переносит проклятие существа на вас.

:ref:`spell--Impending-Doom` :sup:`У` :sup:`SoM` (прориц.): Показывает противнику его возможную кончину и вызывает беспокойство.

:ref:`spell--Life-Connection` :sup:`SoM` (некр.): Устанавливает сопряженность, чтобы получить урон вместо союзника.

:ref:`spell--Mind-of-Menace` :sup:`SoM` (очар.): Устанавливает сопряженность, чтобы покарать врага за ментальный эффект и защитить вас от него.

:ref:`spell--Organsight` :sup:`У` :sup:`SoM` (прориц.): Видите органы противника, и используете эти знания для нанесения точного урона.

:ref:`spell--Positive-Attunement` :sup:`У` :sup:`SoM` (некр.): Настраивает существо на План Позитивной Энергии, исцеляя живое существо или раня :t_undead:`нежить`.

:ref:`spell--Roaring-Applause` :sup:`У` :sup:`SoM` (очар.): Заставляет цель подбадривать вас и аплодировать.

:ref:`spell--Rouse-Skeletons` :sup:`У` :sup:`SoM` (некр.): Поднимает отряд скелетов, чтобы царапать врагов.

:ref:`spell--Soothing-Blossoms` :sup:`SoM` (вопл.): Цветы помогают восстановиться от продолжительного урона и недугов.
...
:ref:`spell--b--Bind-Undead` (некр.): Берете неразумную :t_undead:`нежить` под свое управление.
...
:ref:`spell--Implement-of-Destruction` :sup:`У` :sup:`DA` (очар.): Одно оружие наполняет разум цели экзистенциальным ужасом.

:ref:`spell--Bloodspray-Curse` :sup:`У` :sup:`SoM` (некр.): Проклинает противника более глубокими ранами и кровотечением.

:ref:`spell--Magic-Mailbox` :sup:`Н` :sup:`SoM` (вопл.): Межпространственно связывает 2 контейнера.

:ref:`spell--Painful-Vibrations` :sup:`У` :sup:`SoM` (эвок.): Ранит, оглушает и вызывает тошноту звуковыми вибрациями.

:ref:`spell--Pernicious-Poltergeist` :sup:`У` :sup:`SoM` (некр.): Призывает полтергейст, чтобы творить гадости.

:ref:`spell--Sanguine-Mist` :sup:`У` :sup:`SoM` (некр.): Создает облако тумана осушающего жизнь, который перекачивает жизненную силу в вас.

:ref:`spell--Soothing-Spring` :sup:`У` :sup:`SoM` (некр.): Создает восстанавливающий горячий родник, исцеляющий раны и усталость.

:ref:`spell--Spiritual-Attunement` :sup:`Н, У` :sup:`SoM` (прегр.): Настраивает на планы мировоззрения, чтобы защитить вас и наносить урон существам противоположным этому плану.
...
:ref:`spell--a--Air-Walk` (трансм.): Позволяет ходить по воздуху как по твердой земле.
...
:ref:`spell--Girzanjes-March` :sup:`Н, У` :sup:`AP171` (очар.): Молитва усиливает союзников в области.


Сакральные заклинания 5-го ур.
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

:ref:`spell--Summon-Healing-Servitor` :sup:`У, Н` :sup:`LOIL` (некр.): Призывает слугу исцеляющего ваших союзников и дающего им временные ОЗ.

:ref:`spell--Bandits-Doom` :sup:`У` :sup:`SoM` (прегр.): Устанавливает оберег для защиты предмета.

:ref:`spell--Blessing-Of-Defiance` :sup:`SoM` (прегр.): Усиливает одну из защит союзника.

:ref:`spell--Blink-Charge` :sup:`У` :sup:`SoM` (вопл.): Телепортируетесь и атакуете магической силой.

:ref:`spell--Healing-Well` :sup:`У` :sup:`SoM` (некр.): Создает колодец, который вы с союзниками можете использовать для исцеления.

:ref:`spell--Inevitable-Disaster` :sup:`У` :sup:`SoM` (прориц.): Искажает судьбу, чтобы в ближнем будущем нанести урон врагу.

:ref:`spell--Invoke-Spirits` :sup:`У` :sup:`SoM` (некр.): Призывает группу призрачных явлений, чтобы атаковать ваших врагов.

:ref:`spell--Mirror-Malefactors` :sup:`У` :sup:`SoM` (иллюз.): Зеркала окружают цель, а отражения постоянно атакуют ее.

:ref:`spell--Repelling-Pulse` :sup:`У` :sup:`SoM` (эвок.): Телекинетически отталкивает существ и наносит им урон силой.

:ref:`spell--Rewinding-Step` :sup:`У` :sup:`SoM` (трансм.): Привязывает ваше местоположение во времени, чтобы вы могли быстро вернуться.

:ref:`spell--Rip-The-Spirit` :sup:`У` :sup:`SoM` (некр.): Разрывает дух живого существа негативной энергией, чтобы ранить и :c_drained:`истощить`.

:ref:`spell--Summon-Anarch` :sup:`У` :sup:`SoM` (вопл.): Призывает хаотичного :t_celestial:`небожителя`, :t_monitor:`наблюдателя` или :t_fiend:`беса`.

:ref:`spell--Summon-Axiom` :sup:`SoM` (вопл.): Призывает принципиального :t_celestial:`небожителя`, :t_monitor:`наблюдателя` или :t_fiend:`беса`.
...
:ref:`spell--Suspended-Retribution` :sup:`У` :sup:`DA` (прориц.): Видит катастрофу в будущем, случающуюся когда цель совершает определенное действие.
...
:ref:`spell--Angel-Form` :sup:`У` :sup:`SoM` (трансм.): Превращает в боевую форму :t_angel:`ангела`.

:ref:`spell--Cosmic-Form` :sup:`SoM` (трансм.): Превращает в боевую форму на основе солнца или луны.

:ref:`spell--Deitys-Strike` :sup:`У` :sup:`SoM` (эвок.): На существо с неба падает громадное божественное оружие.
...
:ref:`spell--Canticle-Of-Everlasting-Grief` :sup:`SoM` (очар.): Скорбная панихида пугает противника и наносит ментальный урон, блокируя его бонусы.

:ref:`spell--Divine-Armageddon` :sup:`У` :sup:`SoM` (некр.): Зовете свое божество, чтобы обрушить катаклизм.

:ref:`spell--Summon-Deific-Herald` :sup:`SoM` (вопл.): Призываете инкарнацию представителя своего божества, с эффектами в зависимости от мировоззрения.
...
:ref:`spell--Voracious-Gestalt` :sup:`У` :sup:`SoM` (некр.): Создает духовный гештальт, который поедает души и становится сильнее.
...
:ref:`spell--a--Avatar` (трансм.): Превращает в боевую форму определенную вашим божеством.
...
Оккультные заклинания (Occult Spell List)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. _spells-list--Occult--Cantrips:
...
:ref:`spell--Tame` :sup:`У` :sup:`SoM` (очар.): Одомашненное животное становится к вам более дружелюбным.
...
:ref:`spell--Biting-Words` :sup:`У` :sup:`SoM` (эвок.): Бросает звуковые насмешки, чтобы ранить существ.
...
:ref:`spell--Lose-The-Path` :sup:`SoM` (иллюз.): Реагирует, чтобы помешать и, возможно отвлечь :ref:`action--Stride`.
...
:ref:`spell--i--Ill-Omen` :sup:`APG` (прориц.): Проклинает существо невезением, которое сбивает ее с толку.
...
:ref:`spell--s--Soothe` :sup:`У` (некр.): Исцеляет цель и укрепляет ее против ментальных атак.
...
:ref:`spell--Sonata-Span` :sup:`SoM` (вопл.): Создает дорогу с помощью мотива.

:ref:`spell--Summoners-Precaution` :sup:`SoM` (некр.): Готовит сопряженность, чтобы избежать потери сознания вместе с эйдолоном.

:ref:`spell--Summoners-Visage` :sup:`У` :sup:`SoM` (трансм.): Визуально меняет вашего эйдолона, чтобы он выглядел в точности как вы.

:ref:`spell--Thundering-Dominance` :sup:`У` :sup:`SoM` (очар.): Делает вашего компаньона или эйдолона устрашающим, и позволяет ему издать рёв.
...
:ref:`spell--Moths-Supper` :sup:`У` :sup:`DA` (некр.): Ваше дыхание превращается в зловещих мотыльков, обнаруживающих неподалеку кровопролитие и восстанавливающих вашу жизненную силу.

:ref:`spell--Rally-Point` :sup:`Н, У` :sup:`DA` (вопл.): Обозначает точку в которую можете телепортироваться силой мысли.

:ref:`spell--Sea-of-Thought` :sup:`У` :sup:`DA` (вопл.): Жидкие мысли формируют медленно двигающуюся трясину.

:ref:`spell--Shadow-Spy` :sup:`DA` (некр.): Птица, сделанная из теней и почвы, наблюдает за областью.
...
:ref:`spell--Sudden-Recollection` :sup:`Н` :sup:`SoM` (очар.): Помещаете информацию в подсознание существа, чтобы раскрыть ее по триггеру на ваш выбор.
...
:ref:`spell--Fey-Form` :sup:`SoM` (трансм.): Превращает в боевую форму :t_fey:`феи`.

:ref:`spell--Infectious-Melody` :sup:`SoM` (очар.): Прилипчивый мотив заставляет существ подпевать.
...
:ref:`spell--Tortoise-And-The-Hare` :sup:`SoM` (трансм.): Ускоряет союзника и замедляет противника.
...
:ref:`spell--Aberrant-Form` :sup:`У` :sup:`SoM` (трансм.): Превращает в боевую форму :t_aberration:`аберрации`.
...
:ref:`spell--Portrait-Of-The-Artist` :sup:`SoM` (иллюз.): Кажется будто у вас внешность и навыки известного артиста.
...
Природные заклинания (Primal Spell List)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
:ref:`spell--Healing-Plaster` :sup:`У` :sup:`SoM` (трансм.): Превращает грязь в исцеляющий гипс для лечения ран без набора лекаря.
...
:ref:`spell--Animal-Allies` :sup:`У` :sup:`SoM` (вопл.): Призывает животных, чтобы они недолго атаковали соседних противников.

:ref:`spell--Breadcrumbs` :sup:`У` :sup:`SoM` (прегр.): Оставляет след за существом.

:ref:`spell--Horizon-Thunder-Sphere` :sup:`У` :sup:`SoM` (эвок.): Собирает энергию и метает шаровую молнию.

:ref:`spell--Juvenile-Companion` :sup:`У` :sup:`SoM` (трансм.): Превращает вашего компаньона в его юную форму.

:ref:`spell--Lose-The-Path` :sup:`SoM` (иллюз.): Реагирует, чтобы помешать и, возможно отвлечь :ref:`action--Stride`.

:ref:`spell--Mud-Pit` :sup:`SoM` (вопл.): Создает грязь для замедления передвижения.

:ref:`spell--Protector-Tree` :sup:`У` :sup:`SoM` (вопл.): Воплощает дерево, которое получает урон вместо соседних союзников.
...
:ref:`spell--Swampcall` :sup:`Н, У` :sup:`AP171` (трансм.): Превращает землю в грязь, мешающую существам.
...
:ref:`spell--Feral-Shades` :sup:`У` :sup:`SoM` (некр.): Конус теней в форме гончих разрывает существ.
...
:ref:`spell--Rapid-Adaptation` :sup:`SoM` (трансм.): Адаптируете своего компаньона или эйдолона к окружающей среде.
...
:ref:`spell--Envenom-Companion` :sup:`У` :sup:`SoM` (некр.): Делает атаки вашего компаньона токсичными.
...
:ref:`spell--Elemental-Gift` :sup:`У` :sup:`SoM` (трансм.): Наполняет союзника одной из 4 стихий.

:ref:`spell--Fey-Form` :sup:`SoM` (трансм.): Превращает в боевую форму :t_fey:`феи`.

:ref:`spell--Murderous-Vine` :sup:`У` :sup:`SoM` (вопл.): Хватает существо лозой.

:ref:`spell--Ocular-Overload` :sup:`SoM` (иллюз.): Устанавливает сопряженность, чтобы вмешаться в зрение атакующего вас существа.

:ref:`spell--Petal-Storm` :sup:`У` :sup:`SoM` (вопл.): Буря острых как бритва лепестков режет существ в области.
...
:ref:`spell--Natures-Reprisal` :sup:`У` :sup:`SoM` (трансм.): Злит растительную жизнь, чтобы замедлить противников и нанести им урон.
...
:ref:`spell--Clone-Companion` :sup:`SoM` (вопл.): Создает копию зверя-компаньона, которая повторяет действия вашего компаньона.

:ref:`spell--Whirlwind` :sup:`У` :sup:`SoM` (эвок.): Создает двигающийся торнадо, чтобы наносить урон существам и поднимать их в воздух.
...
:ref:`spell--One-With-The-Land` :sup:`SoM` (трансм.): Сливаетесь с элементом ландшафта, чтобы контролировать окружающую среду поблизости.
...
:ref:`spell--Element-Embodied` :sup:`SoM` (трансм.): Превращает в громадного элементаля.

:ref:`spell--Fated-Confrontation` :sup:`SoM` (прориц.): Изолирует двух предопределенных противников и дает им искажать судьбы друг друга.

:ref:`spell--Nullify` :sup:`SoM` (прегр.): Реагируете, чтобы автоматически противодействовать заклинанию и получить урон от отдачи.

:ref:`spell--Summon-Kaiju` :sup:`Р` :sup:`SoM` (вопл.): Призывает инкарнацию кадзю с эффектами в зависимости от конкретного кайдзю.
...
.. _spells-list--Elemental:

Стихийные заклинания (Elemental Spell List)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Смотрите правила про :ref:`unlimited-magic--Elementalism`.

.. _spells-list--Elemental--Cantrips:
